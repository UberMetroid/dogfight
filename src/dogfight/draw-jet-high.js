...
DRAW_JET[7] = function (ctx, jet, fPrimary, fAccent, isLead, colors, alpha, time) {
  var faction = (typeof FACTION_COLORS !== "undefined" && jet && (jet.team === "east" || jet.isEast)) ? FACTION_COLORS.east : ((typeof FACTION_COLORS !== "undefined") ? FACTION_COLORS.west : { glow: fAccent || "rgba(56, 189, 248, 0.35)" });
