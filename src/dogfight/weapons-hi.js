// # Weapons gens 5-7 — West vs East
//
// Logline: Gen 5 high-band missiles, Gen 6 NGAD DEW laser + CCA wingman, Gen 7 SWARM
//          omnidirectional pulse, tri-lance particle beam, and singularity cannon.
//          Strategic bombers are still out (no bomber targeting).
//
function evaluateJetWeapons(jet, targetEnemy, colors) {
  ...
  // Gen 7: Swarm directed weapons (omnidirectional pulse, tri-lance, singularity)
  if (jet.gen === 7) {
      ...
      if (typeof globalVfxParticlePool !== "undefined" && globalVfxParticlePool) {
        for (var psw = 0; psw < 2; psw++) {
          ...
          if (swIdx >= 0) {
            ...
            globalVfxParticlePool.buffer[swo + 7] = 2;
          }
        }
      }
    ...
    // Gen 6: NGAD 150 kW DEW Laser CIWS + CCA wingman forward-firing laser
